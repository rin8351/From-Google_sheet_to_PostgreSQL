...
7. Идет отсчет времени и выполнение функций:
  ...
  7.4. каждый час проверяется наступило ли 8 часов утра. ЕСли да, идет проверка наличия заказов с истекшим сроком поставки. Если такой есть, в телеграмм бот отправляется сообщение с номером этого заказа.
